    ...
    return(
       ...
       <PinchZoomView>
        ...
        <Footer >
            ...
            {/* <Button  block onPress={()=>this.props.navigation.navigate('FoodsBeverages',{shopid:this.state.clonedParams})
                      }>
    ...
    return(
        Alert.alert(
           ...
           'your claimed payment is Rs, '+this.state.price,
            ...
            {text: 'Buy it Now', onPress: () => {this.props.navigation.navigate('Buy2',{price:this.state.price})
