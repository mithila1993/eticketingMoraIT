...
class Approvecarparkowners extends Component {
    constructor(props) {
        super(props);
        this.state = {
            datas:{}
        }
        this.getApproveCarParkOwners = this.getApproveCarParkOwners.bind(this);
        this.delete = this.delete.bind(this);
    }


    getApproveCarParkOwners(){
        axios.post('http://localhost:3002/approveCarParkOwnersOnAdmin', {
    ...
    render() {
        ...
        return (
            <div>
                <h1>Approved Car Park Owners</h1>
...
export default Approvecarparkowners;