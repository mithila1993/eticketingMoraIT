...
class Approvenormalusers extends Component {
    constructor(props) {
        super(props);
        this.state = {
            datas:{}
        }
        this.getApproveUsers = this.getApproveUsers.bind(this);
        this.delete = this.delete.bind(this);
    }


    getApproveUsers(){
        axios.post('http://localhost:3002/approveNormalUsersOnAdmin', {
...
export default Approvenormalusers;