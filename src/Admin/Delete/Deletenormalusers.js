...
class Deletenormalusers extends Component {
    constructor(props) {
        super(props);
        this.state = {
            datas:{}
        ...
        this.getDeleteUsers = this.getDeleteUsers.bind(this);
    }

getDeleteUsers(){
    axios.post('http://localhost:3002/deleteNormalUsersOnAdmin', {
...
export default Deletenormalusers;